...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="SELinux file_contexts patcher")
    parser.add_argument("dir_path", help="Partition location (ex: unpacked_product)")
    parser.add_argument("fs_config", help="File contexts file (ex: product_file_contexts)")
    parser.add_argument("-f", "--fix-permission", dest="fix_permission_file", default=None,
                         help="JSON file that includes manuel context rules (optional)")
    args = parser.parse_args()
    main(args.dir_path, args.fs_config, args.fix_permission_file)
